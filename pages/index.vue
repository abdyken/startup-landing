...
const productMoments = [
  {
    ...
    title: 'Feed started',
    copy:
      'Start a feed with one thumb. The side you are on stays on screen, and the bottle amount is one tap away.',
  ...
  },
  {
    ...
    title: 'Sleep started',
    copy:
      'Mark sleep without setting up a routine. Start time, last nap, and the wake window stay in view.',
  ...
  },
  {
    ...
    copy:
      'One of you logs the night. The other wakes up to a calm recap of last feed, sleep, and diapers, so neither of you has to piece it together at 3AM.',
    ...
    event: {
      ...
      detail: 'Last feed, sleep, and 3 diapers. 4 events overnight.',
    },
  },
]
...
const faqs = [
  {
    ...
    answer:
      'No. Lullaby does not diagnose anything and does not replace your pediatrician. For common newborn worries it gives a calm, plain answer, and it points out the signs that mean you should call a doctor.',
  },
  {
    question: 'What can I log?',
    answer:
      'Feeds, breast side, bottle amount, sleep, wet or dirty diapers, and short notes for the night.',
  },
  {
    question: 'Can I share the night log with my partner?',
    answer:
      'Yes. The point is a quiet handoff: your partner can see last feed, diaper, sleep, and bottle without anyone waking the other.',
  },
  {
    question: 'What newborn worries are covered?',
    answer:
      'The everyday ones: spit-up, hiccups, cluster feeding, gas, diaper color, feeding that never seems to stop, and the "is this normal?" moments. Each answer comes with its limits and the red flags that mean you should call someone.',
  },
  {
    question: 'When is it launching?',
    answer:
      'Private beta first. Join the waitlist and we will send one email the day the first build opens. That is it.',
  },
]
            ...
            <div class="hero-inner">
              <div class="hero-copy">
                ...
                <p class="hero-subcopy">
                  Log a feed, a diaper, or a stretch of sleep with one thumb in
                  the dark. In the morning, you and your partner wake up knowing
                  what happened.
                </p>
      ...
      <section id="nightlog" class="product-story section motion-ready" aria-labelledby="story-heading">
        ...
        <div class="container product-story-grid">
          ...
          <div class="story-copy section-heading reveal-item">
            ...
            <p>
              The night log stays short: feed, sleep, a wet or dirty diaper, the
              handoff to your partner, and a calm next step for common newborn worries.
            </p>
          </div>
      ...
      <section id="waitlist" class="final-cta section">
        <div class="container final-inner reveal-item">
          <div class="section-heading narrow">
            ...
            <h2>Get the first night-shift build.</h2>
            <p>
              For parents logging feeds, diapers, sleep, and handoffs at 3AM. We
              send one email when the private beta opens, and nothing else.
            </p>
          </div>
      ...
      <section id="faq" class="faq section">
        <div class="container">
          <div class="section-heading narrow">
            ...
            <h2>Questions new parents ask.</h2>
            <p>
              Lullaby keeps night logging quick and gives a calm answer to common
              worries. It does not diagnose anything, and it will not bury you in charts.
            </p>
          </div>
    ...
    <footer class="site-footer">
      <div class="footer-top reveal-item">
        ...
        <div class="footer-close">
          ...
          <p class="footer-lead">
            One-handed logs, calm morning recaps, and a steady answer for the
      ...
      <div class="footer-legal">
        ...
        <p class="footer-disclaimer">
          Lullaby does not provide medical diagnosis or treatment. Always contact
          your pediatrician or healthcare provider with any medical concerns.
        </p>
      </div>
    </footer>
  </div>
